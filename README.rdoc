...
This genome (same as genome_normal) was evolved to solve rubywarrior in normal mode and will get as far as level 7 (and has some nice behaviours).
Once at level 8 copy the genome_epic file into the folder and rename it to genome.  This genome was evolved in epic mode and will complete normal mode levels 8 and 9 and then all of the levels on epic.  It the current best, I hope to get it a bit better.
